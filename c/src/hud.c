                   ...
                   const float deadzone)
{
    ...
    DrawCircleLines(center_x, center_y, max_size / 3.0f, Fade(WHITE, 0.5f));
    DrawCircleLines(center_x, center_y, deadzone, Fade(WHITE, 0.5f));
}
                  ...
                  const float health)
{
    ...
    float health_size = ring_size * (health / 100.0f);
    health_size       = Clamp(health_size, 0.0f, ring_size);
